...
//选择订单类型
  ...
  bindPickerChange2(e){
    // console.log(e)
    var orderStateList = this.data.orderStateList || [];
    var value = e.detail.value;
    // console.log(value)
    this.setData({
      index1:value,
      'orderInfo.orderState': orderStateList[value].id
    })
  },
...
submintFun:function(e){
  ...
  if(orderInfo.userName.length==0){
    ...
    https.getJSON('/share/agentIntentionOrder/addIntentionOrder',orderInfo).then(res=>{
      console.log(res)
